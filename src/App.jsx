...
function App() {
  ...
  return (
    <div className="site-shell">
      ...
      <footer className="footer wrap"><a className="brand" href="#home"><span>KS</span><strong>Kuruva Siva</strong></a><p>Designed &amp; built with curiosity. © {new Date().getFullYear()}</p><div className="socials"><a href="https://github.com/kuruvasivasiva1417-ops" target="_blank" rel="noopener noreferrer" aria-label="GitHub"><Link size={18} /></a><a href="#contact" aria-label="Instagram"><CircleUserRound size={18} /></a></div></footer>
    </div>
  )
}
